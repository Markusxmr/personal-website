<figure class="mb-10">
	...
	<figcaption class="text-center">
		Photo by <a
			href="https://www.pexels.com/photo/black-samsung-tablet-computer-106344/"
			target="_blank"
			rel="noopener noreferrer">PhotoMIX Company</a
		>
		from <a href="https://www.pexels.com" target="_blank" rel="noopener noreferrer">Pexels</a>
	</figcaption>
</figure>
...
<article class="blog-post">
	...
	<hr />
	<p>
		This is some additional paragraph placeholder content. It has been written to fill the available space and show how
		a longer snippet of text affects the surrounding content. We'll repeat it often to keep the demonstration flowing,
	...
	<p>
		HTML defines a long list of available inline tags, a complete list of which can be found on the <a
	...
	<ul>
		...
		<li>
			<del>Deleted</del> text should use <code class="language-plaintext highlighter-rouge">&lt;del&gt;</code>
			and
			<ins>inserted</ins>
			text should use <code class="language-plaintext highlighter-rouge">&lt;ins&gt;</code>.
		</li>
		<li>
			Superscript <sup>text</sup> uses <code class="language-plaintext highlighter-rouge">&lt;sup&gt;</code> and
