	...
	<section>
		<div class="flex items-center justify-between" style="opacity: 1;">
			...
			<div class="flex items-center gap-2 border-b-2 border-gray-500 pb-2">
				...
				<a href={`/${BASE_URI}/blogs/rss`} style="opacity: 1; transform: none;">
					<svg
						stroke="currentColor"
						fill="currentColor"
						stroke-width="0"
						...
						width="1em"
						xmlns="http://www.w3.org/2000/svg"
						><title>RSS</title><path d="M19 20.001C19 11.729 12.271 5 4 5v2c7.168 0 13 5.832 13 13.001h2z" />
			...
			{#each articles ?? [] as attributes}
				...
				>
					<div>
						...
						<p class="font-normal text-gray-700 dark:text-gray-500">
