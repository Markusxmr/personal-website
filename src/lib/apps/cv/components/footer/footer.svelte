...
<footer class="mt-20 rounded-lg bg-gray-100 text-center text-gray-400 lg:text-left">
	<div class="mx-6 flex justify-center border-b border-gray-200 py-7 pt-10 text-center">
