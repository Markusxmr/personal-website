<div class="pr-3">
	...
	<div class="eading-none text-justify">
		...
		<p>
			I focus on details, delivering feature-full, future-proof and easily maintainable solutions. <br />
			Preference for considerations ahead of design decisions, solutioning complex issues and white-boarding architectures
			and schemas.
		</p>
	</div>
</div>
