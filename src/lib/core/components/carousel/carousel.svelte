<script lang="ts">
	const IMAGE_PLACEHOLDER = '/wine-code/images/banner/landscape-vineyard-wine-field-hill.jpg';
</script>
...
<div id="default-carousel" class="relative" data-carousel="static">
	...
	<div class="relative h-56 overflow-hidden rounded-sm md:h-96">
		<!-- Item 1 -->
		<div class="absolute inset-0 translate-x-0 transform transition-all duration-700 ease-in-out" data-carousel-item="">
			<span
		...
		<!-- Item 2 -->
		<div
			class="absolute inset-0 z-10 translate-x-full transform transition-all duration-700 ease-in-out"
			data-carousel-item=""
		>
			<img
				src={IMAGE_PLACEHOLDER}
