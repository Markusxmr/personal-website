...
import { APPLICATION_SLUG } from '$lib/core/constants';
...
for (const language of languages) {
	const appSlug = APPLICATION_SLUG ? APPLICATION_SLUG : "core";
	register(`${language}`, () => import(`$lib/apps/${appSlug}/locale/${language}.json`));
}
